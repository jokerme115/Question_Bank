...
public class LogInFrm {
	...
	private void initialize() {
		...
		FrmLogIn.setFont(new Font("Dialog", Font.BOLD, 18));
		FrmLogIn.getContentPane().setForeground(Color.MAGENTA);
		FrmLogIn.setTitle("\u6CE8\u518C\u754C\u9762");
		FrmLogIn.setBounds(100, 100, 991, 656);
		...
		FrmLogIn.getContentPane().add(Return);
		...
		FrmLogIn.getContentPane().add(table);
		...
		FrmLogIn.getContentPane().add(textNumber);
		...
		FrmLogIn.getContentPane().add(textE_Mail);
		...
		FrmLogIn.getContentPane().add(lblPhonenumber);
